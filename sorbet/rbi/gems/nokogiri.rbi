...
class Nokogiri::XML::SAX::Parser::Attribute < Anonymous_Struct_15
end
...
class Nokogiri::XML::Notation < Anonymous_Struct_16
end
...
class Nokogiri::HTML::EntityDescription < Anonymous_Struct_17
end
